// OpenAero rules-imac.js file 2-3-23 version
...
// Added Invitational Class to support sequence design above Unlimited. 
// These are not officially supported as normal IMAC approved classes 
// but are setup as a courtesy to better support Major events such as 
// the Tucson Aerobatic Shootout, that primarily fly IMAC classes with 
// Invitational class requirements.
// Added by David Garceau - April 2026 
...
"year=2026",
	...
	//#####################################################################################
	//#################   IMAC Invitational Known   ######################################
	//#####################################################################################
	"[IMAC Invitational Known]",
	"more=IMAC Invitational Unknown",

	//#####################################################################################
	//#################   IMAC Invitational Alt-Known   ##################################
	//#####################################################################################
	"[IMAC Invitational Alt-Known]",
	"more=IMAC Invitational Alt-Unknown",
	...
	*/
	...
	//Combination rolls or single roll elements on all lines cannot be in excess of 540 degrees, excluding spins.
	...
	*/
	...
	//8.5 Half Cubans
	"8.5.1.2-4",
	"8.5.1.1 noposflick:2",
	"8.5.2.1",
	"8.5.2.2 noposflick:2",
	"8.5.2.3-4",
	"8.5.3.1-4",
	"8.5.4.1-4",
	"8.5.5.1",
	"8.5.5.2 noposflick:1",
	"8.5.5.3-4",
	"8.5.6.1",
	"8.5.6.2 noposflick:1",
	"8.5.6.3-4",
	"8.5.7.1-4",
	"8.5.8.1-4",
	...
	"8.10.1.2 MAX360:2; NOU:2; noposflick:1",
	"8.10.1.4 MAX360:2; NOU:2",
	"8.10.2.1 MAX360:2; NOU:2",
	"8.10.2.2 MAX360:2; NOU:2; noposflick:1",
...
/*ptsqtr used to limit points per line in 5.3 and 5.4*/	
	...
	*/
	...
	//#################################################################################################
	//##############################  IMAC Invitational Alt-Unknown  ##################################
	//#################################################################################################
	// Same figures as Unlimited but with relaxed restrictions:
	// - Roll limits doubled from Unlimited
	// - Point roll limits removed
	// - Vertical S and Vertical 8 limits removed
	// - Stall turn restrictions removed

	"[IMAC Invitational Alt-Unknown]",
	"rule-MAX1440dn45=qtrs:<17",
	"why-MAX1440dn45= On 45º down-lines that require a 135º push or pull to figure exit, roll elements may not exceed 1440º (4 rolls)",

	"conv-downqtrs=^9\\.([1-9]|10)\\.([459]|10)\\.([1-8]) = $3; ^9\\.(1[12])\\.1\\.([4-8]) = z; ^9\\.([1-9]|10)\\.[123678]\\.([1-8]) = z ",
	"rule-downmax1800 = downqtrs:<21",
	"why-downmax1800 = Combination or total roll elements on down-lines of 45º and vertical may not exceed 1800º (5 rolls).",

	"conv-climbqtrs=^9\\.([1-9]|10)\\.[1267]\\.([1-8]) = $2; ^9.([1-9]|10).([459]|10)\\.[1-8] = z; ^9\\.([1-9]|10)\\.3\\.([1-8]) = 0; ^9\\.1[12]\\.1\\.[4-8] = 0",
	"rule-climbmax2160 = climbqtrs:<25",
	"why-climbmax2160 = Combination or total roll elements on up-lines of 45º and vertical may not exceed 2160º (6 rolls).",

	"rule-MAX180= qtrs:<3",
	"why-MAX180 = 1/2 roll only",

	//Default rules
	"allow-defrules=climbmax2160; downmax1800",
	...
	"1.1.3.1-4",
	"1.1.4.1-2",
	"1.1.4.3-4 MAX1440dn45",
	"1.1.5.1-2",
	"1.1.5.3-4 MAX1440dn45 ",
	"1.1.6.1-4",
	"1.1.7.1-4",
	"1.1.8.1-2",
	"1.1.8.3-4 MAX1440dn45",
	"1.1.9.1-2",
	"1.1.9.3-4 MAX1440dn45",
	"1.1.10.1-4",
	"1.1.11.1-4",
	...
	"1.2.13.1-2",
	"1.2.13.3-4",
	"1.2.14.1-2 MAX1440dn45:2",
	"1.2.14.3-4",
	"1.2.15.1-2 MAX1440dn45:2",
	"1.2.15.3-4",
	"1.2.16.1-2 MAX1440dn45:2",
	"1.2.16.3-4",
	...
	//Family 5 Stall Turns (no additional restrictions beyond default roll limits)
	"5.2.1.1-4",
	"5.3.1.1-4",
	"5.3.2.1-4",
	"5.3.3.1-4",
	...
	//Vertical S (no restrictions for Invitational)
	"7.5.9.1-4",
	"7.5.10.1-4",
	...
	//Vertical 8 (no restrictions for Invitational)
	"7.8.17.1-4",
	"7.8.18.1-4",
	"7.8.19.1-4",
	"7.8.20.1-4",
	...
	// Diagonal Humpty Bumps
	"8.4.5.1-2 MAX1440dn45:2",
	"8.4.5.3-4",
	"8.4.6.1-2 MAX1440dn45:2",
	"8.4.6.3-4",
	"8.4.7.1-2 MAX1440dn45:2",
	"8.4.7.3-4",
	"8.4.8.1-2 MAX1440dn45:2",
	"8.4.8.3-4",
	"8.4.9.1-2 MAX1440dn45:2",
	"8.4.9.3-4",
	"8.4.10.1-2 MAX1440dn45:2",
	"8.4.10.3-4",
	"8.4.11.1-2 MAX1440dn45:2",
	"8.4.11.3-4",
	"8.4.12.1-2 MAX1440dn45:2",
	"8.4.12.3-4",
	"8.4.13.1-2",
	"8.4.13.3-4",
	"8.4.14.1-2",
	...
	"8.5.20.1-2",
	"8.5.20.3-4",
	"8.5.21.1-2 MAX1440dn45:2",
	"8.5.21.3-4",
	"8.5.22.1-2 MAX1440dn45:2",
	"8.5.22.3-4",
	"8.5.23.1-2 MAX1440dn45:2",
	"8.5.23.3-4",
	"8.5.24.1-2 MAX1440dn45:2",
	"8.5.24.3-4",
	...
	//#################################################################################################
	//##############################  Invitational Unknown (adds rolling turns)  ######################
	//#################################################################################################
	"[IMAC Invitational Unknown]",
	"2.1.2.1-4",
	"2.1.3.1-4",
