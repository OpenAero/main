...
/***********************************************************************
 * This file defines specific rules
 * 
 ...
 * The rules.js file is the main file.
 * The rules-ORG.js file should contain information for ORG organization
 ...
 * 
 * Every rule file should start rule definition with a "year" directive.
 * year=rulefile year
 *   defines the validity year of the rules file (usually latest update)
 *   e.g. year=2025
 * 
 ...
 * On OpenAero startup:
 *  1. The latest rules file is loaded and the general rules are stored
 *  2. All rules-rules.js files are loaded, where "rules" is the sequence
