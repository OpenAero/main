// OpenAero rules17-nzac-civa.js file
...
// This file defines rules for the NZAC 2016/2017 season as in NZAC 2016
...
/*
rules.push("[NZAC Unlimited Programme1]");
rules.push("more=NZAC Unlimited #2 Free Known");
rules.push("[NZAC Unlimited Programme2]");
rules.push("more=NZAC Unlimited #4 Free Unknown");
rules.push("[NZAC Unlimited Programme3]");
rules.push("more=NZAC Unlimited Unknown2");
rules.push("[NZAC Unlimited Programme4]");
rules.push("more=NZAC Unlimited Unknown3");
*/

//######################################################################################
//##### NZAC UNLIMITED KNOWN ###########################################################
//######################################################################################

rules.push("(NZAC Unlimited Known)");
...
rules.push("(NZAC Unlimited Free)");
rules.push("posnl=40");//assume no line judges
rules.push("poslj=20");

rules.push("more=NZAC/IAC Unlimited Free");

//######################################################################################
//##### NZAC/IAC UNLIMITED FREE ########################################################
//######################################################################################

rules.push("(NZAC/IAC Unlimited Free)");
...
rules.push("[NZAC Unlimited #2 Free Known]");
rules.push("posnl=40");//assume no line judges
rules.push("poslj=20");
rules.push("reference=\/ \"@A\" ```````````+24rpp(f)24 \"@B\" ,3'pbB(,2if),34-`> \"@C\" --,2m,32,2if- \"@D\" -3jo15 \"@E\" ``+,4ita``2f'+`");

rules.push("more=NZAC/IAC Unlimited #2 Free Known");

//######################################################################################
//##### NZAC/IAC UNLIMITED FREE KNOWN ##################################################
//######################################################################################

rules.push("(NZAC/IAC Unlimited #2 Free Known)");
...
rules.push("[NZAC Unlimited #4 Free Unknown]");
rules.push("more=NZAC Unlimited FreeUnknown");
rules.push("(NZAC Unlimited 1stUnknown)");
rules.push("more=NZAC Unlimited FreeUnknown");

/*
rules.push("[NZAC Unlimited Unknown2]");
rules.push("more=NZAC Unlimited FreeUnknown");
rules.push("(NZAC Unlimited 2ndUnknown)");
rules.push("more=NZAC Unlimited FreeUnknown");

rules.push("[NZAC Unlimited Unknown3]");
rules.push("more=NZAC Unlimited FreeUnknown");
*/

rules.push("(NZAC Unlimited FreeUnknown)");
...
/*
rules.push("[NZAC Advanced Programme1]");
rules.push("more=NZAC Advanced #2 Free Known");
rules.push("[NZAC Advanced Programme2]");
rules.push("more=NZAC Advanced #4 Free Unknown");
rules.push("[NZAC Advanced Programme3]");
rules.push("more=NZAC Advanced Unknown2");
rules.push("[NZAC Advanced Programme4]");
rules.push("more=NZAC Advanced Unknown3");

rules.push("(NZAC Advanced Unknown)");
rules.push("more=NZAC Advanced #4 Free Unknown");
rules.push("(NZAC Advanced 1stUnknown)");
rules.push("more=NZAC Advanced #4 Free Unknown");
rules.push("(NZAC Advanced 2ndUnknown)");
rules.push("more=NZAC Advanced Unknown2");
*/

//######################################################################################
//##### NZAC ADVANCED KNOWN 2015 #######################################################
//######################################################################################

rules.push("(NZAC Advanced Known)");
rules.push("basefig-min=9");
rules.push("basefig-max=9");
rules.push("poslj=10");
rules.push("posnl=30");
...
//######################################################################################
//##### NZAC ADVANCED FREE 2015 ########################################################
//######################################################################################

rules.push("(NZAC Advanced Free)");
...
rules.push("more=NZAC AdvYakInt SF");

//######################################################################################
//##### NZAC ADVANCED FREE KNOWN #######################################################
//######################################################################################

rules.push("[NZAC Advanced #2 Free Known]");
rules.push("posnl=30");//no line judges
rules.push("poslj=10");
...
rules.push("[NZAC Advanced #4 Free Unknown]");
rules.push("k-maxperfig=30");
rules.push("more=NZAC Advanced Unknownall");

/*
rules.push("[NZAC Advanced Unknown2]");
rules.push("k-maxperfig=35");
rules.push("more=NZAC Advanced Unknownall");

rules.push("[NZAC Advanced Unknown3]");
...
/*
rules.push("[NZAC Yak52 Programme1]");
rules.push("more=NZAC Yak52 #2 Free Known");
rules.push("[NZAC Yak52 Programme2]");
rules.push("more=NZAC Yak52 #4 Free Unknown");
rules.push("[NZAC Yak52 Programme3]");
rules.push("more=NZAC Yak52 Unknown2");
rules.push("[NZAC Yak52 Programme4]");
rules.push("more=NZAC Yak52 Unknown3");

rules.push("[NZAC Intermediate Programme1]");
rules.push("more=NZAC Intermediate #2 Free Known");
rules.push("[NZAC Intermediate Programme2]");
rules.push("more=NZAC Intermediate #4 Free Unknown");
rules.push("[NZAC Intermediate Programme3]");
rules.push("more=NZAC Intermediate Unknown2");
rules.push("[NZAC Intermediate Programme4]");
rules.push("more=NZAC Intermediate Unknown3");
*/
...
rules.push("[NZAC Yak52 #2 Free Known]");
rules.push("posnl=30");//no line judges
rules.push("poslj=10");
...
rules.push("[NZAC Intermediate #2 Free Known]");
rules.push("more=NZAC Yak52 #2 Free Known");
...
//######################################################################################
//##### NZAC INTERMEDIATE FREE 2015 ####################################################
//######################################################################################

rules.push("(NZAC Intermediate Free)");
rules.push("more=NZAC Yak52 Free");

//######################################################################################
//##### NZAC YAK52 UNKNOWN #############################################################
//######################################################################################

rules.push("(NZAC Yak52 Unknown)");
rules.push("more=NZAC Yak52 #4 Free Unknown");
rules.push("(NZAC Yak52 1stUnknown)");
rules.push("more=NZAC Yak52 #4 Free Unknown");
rules.push("(NZAC Yak52 2ndUnknown)");
rules.push("more=NZAC Yak52 Unknown2");

rules.push("[NZAC Yak52 #4 Free Unknown]");
rules.push("k-maxperfig=20");
rules.push("more=NZAC Yak52 Unknownall");

/*
rules.push("[NZAC Yak52 Unknown2]");
rules.push("k-maxperfig=25");
rules.push("more=NZAC Yak52 Unknownall");

rules.push("[NZAC Yak52 Unknown3]");
rules.push("k-maxperfig=30");
rules.push("more=NZAC Yak52 Unknownall");
*/
...
//rules.push("(NZAC Intermediate Unknown)");
//rules.push("more=NZAC Yak52 #4 Free Unknown");
//rules.push("(NZAC Intermediate 1stUnknown)");
//rules.push("more=NZAC Yak52 #4 Free Unknown");
//rules.push("(NZAC Intermediate 2ndUnknown)");
//rules.push("more=NZAC Yak52 Unknown2");

rules.push("[NZAC Intermediate #4 Free Unknown]");
rules.push("more=NZAC Yak52 #4 Free Unknown");

/*
rules.push("[NZAC Intermediate Unknown2]");
rules.push("more=NZAC Yak52 Unknown2");

rules.push("[NZAC Intermediate Unknown3]");
rules.push("more=NZAC Yak52 Unknown3");
*/
