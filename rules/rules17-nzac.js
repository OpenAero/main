...
// This file defines NZAC Recreational/Sports rules for 2017
...
rules.push("[NZAC Primary Known]");
rules.push("posnl=3");
rules.push("demo=d iv```s.. c.'',2 o 2j~ 1");

//###############################################################################
//##### NZAC RECREATIONAL KNOWN #################################################
//###############################################################################

rules.push("[NZAC Recreational Known]");
rules.push("posnl=20");
rules.push("demo=m2+ 11% 2j s h.. b 1% `````2``rc+````````` (-3,9) o 1");
