...
rules.push("sf = advanced");// Ajout 2014 pour OpenAero
...
rules.push("1.1.3.1");
rules.push("1.1.3.4");
// rules.push("1.1.6.1 NR:1");  # Modif 2015 suppression figure
rules.push("1.1.6.3 SPIN");
rules.push("1.1.7.1 NR:1");  // Modif 2015 ajout figure
...
rules.push("9.2.3.6");
rules.push("9.2.3.8");
rules.push("9.4.3.2");  // Modif 2015 ajout rotation
rules.push("9.4.3.4");  // Modif 2015 ajout rotation
...
rules.push("sf = unlimited");// Ajout 2014 pour OpenAero
