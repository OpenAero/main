...
//######################################################################################
//#####      Regles France 2014      Espoirs à Doret 2014  Olan 6.0  ###################
//#####      Regles France 2014      Version 2014_PN.1.00            ###################
//######################################################################################
//######################################################################################
//#####                                                              ###################
...
//#####                                                              ###################
//######################################################################################
// prog 2014 : Espoirs, Desavois, National2, Doret
...
// Olan sequence
//demo = k2 6> ~m2 ivs.'' `````2```rc+``` 5>5^ m- -1- -2% -3j- -2 3j h.. o
...
// Openaero Tag (4 field Aresti number)  Ajout 2014 for OpenAero
...
// Openaero sequence  Ajout 2014 for OpenAero
rules.push("demo = ed 2% 22g1- 5% `-iv.is.'~ 2% 5> mf,1- (0,19) ``-2c2.'' 24pb4.''+`` ~~8'h...'-~~> 2> -o2 5% 2> m-` -`2if,1+`` -2% ``+3jio3");
// Olan sequence
...
// Openaero sequence  Ajout 2014 for OpenAero
rules.push("demo = ej /.,3ta-```> 6> -2kif,2. 6> ~ifn(...''2....)4- 5> --``,7is.'ibb(`````,2)....''> 17> m2f,1+`` -2% ``+3j15- -h,4.> (-30,13) ````+2rcc(`1`,2f`) ```,24.'g``f");
// Olan sequence
