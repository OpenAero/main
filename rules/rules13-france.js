...
//#####      Regles France 2013      Version 2013_PN.0.50            ###################
//######################################################################################
//######################################################################################
//#####                                                              ###################
...
rules.push("more = France  France espoirs all");
...
// Regle PG : Rotations alternées autorisées uniquement sur les figures 1.1.1.1-4 et limitées 540° maximum.
...
rules.push("rule-Max_alt_540 = rot_alt: (8,|,8|6,|,6|4,4)");
rules.push("why-Max_alt_540 = Rotation alternee limitee a 540 degres");

rules.push("allow-defrules = No_alt_45");

// Modif 2013 (ou correction) Fin

rules.push("1.1.1.1-4 Max_alt_540 ");// Modif 2013 Max_alt_540
rules.push("1.1.2.1");
...
rules.push("more = France  France desavois all");
...
rules.push("allow-defrules = NFC; V180");
...
rules.push("demo=-d1- -iv5is/ ,4h o1 ~+k''2if..'+``` ```+2g2f- 12% [-8,4] ```-2joi2-``` -4,3 ``h4/ ~~8b m2,\"4x4\"44");
...
rules.push("more = France  France national2 all");
...
rules.push("allow-defrules = NSF; V180");
...
rules.push("demo=~~-,fpb`,2'' '',24ita.' n(''.6if..''),\"|\"4'/ ``7s''ik``2f```- 14% ~-48a34,3-``` ````-2ccc(2)6f,6-````` -3% ~-3jo3---~/ ~~--''8'h.> ''\"|\"24g2,if'-");
...
rules.push("why-R6 = ce declenche est interdit. Sauf sur les figures 7.2.2.1, 7.2.4.2, 8.5.3.3, 8.5.3.4, 8.6.2.4 et 8.6.4.3.");
