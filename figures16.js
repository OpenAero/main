...
figs.push("+&irp_+ 8.6.1.3(15) ~V''_''~P_''~");
figs.push("-&irp_- 8.6.1.4(12) ~v''_''~p_''~");

// 8.6.2.1-4
figs.push("+&rp(_)^- 8.6.2.1(12) ~v~_~~p!__''~");
figs.push("-&rp(_)^+ 8.6.2.2(16) ~V~_~~P!__''~");
figs.push("+&irp^- 8.6.2.3(16) ~V~_~~P_''~");
figs.push("-&irp^+ 8.6.2.4(12) ~v~_~~p_''~");

// 8.6.3.1-4
figs.push("+&rp(_)_- 8.6.3.1(15) ~v''_''~P!__''~");
figs.push("-&rp(_)_+ 8.6.3.2(13) ~V''_''~p!__''~");
figs.push("+&irp_- 8.6.3.3(13) ~V''_''~p_''~");
figs.push("-&irp_+ 8.6.3.4(14) ~v''_''~P_''~");

// 8.6.4.1-4
figs.push("+&rp(_)^+ 8.6.4.1(14) ~v~_~~P!__''~");
figs.push("-&rp(_)^- 8.6.4.2(13) ~V~_~~p!__''~");
figs.push("+&irp^+ 8.6.4.3(13) ~V~_~~p_''~");
figs.push("-&irp^- 8.6.4.4(15) ~v~_~~P_''~");

// 8.6.5.1-4
figs.push("+_p(_)&+ 8.6.5.1(11) ~~_p!_~~_''v~");
figs.push("-_p(_)&- 8.6.5.2(16) ~~_P!_~~_''V~");
figs.push("+_ip&+ 8.6.5.3(16) ~~_P~~_''V~");
figs.push("-_ip&- 8.6.5.4(12) ~~_p~~_''v~");

// 8.6.6.1-4
figs.push("+_p(_)&- 8.6.6.1(12) ~~_p!_~~_''V~");
figs.push("-_p(_)&+ 8.6.6.2(15) ~~_P!_~~_''v~");
figs.push("+_ip&- 8.6.6.3(15) ~~_P~~_''v~");
figs.push("-_ip&+ 8.6.6.4(13) ~~_p~~_''V~");

// 8.6.7.1-4
figs.push("+^p(_)&- 8.6.7.1(16) ~~_P!_~~_''V~");
figs.push("-^p(_)&+ 8.6.7.2(12) ~~_p!_~~_''v~");
figs.push("+^ip&- 8.6.7.3(12) ~~_p~~_''v~");
figs.push("-^ip&+ 8.6.7.4(16) ~~_P~~_''V~");

// 8.6.8.1-4
figs.push("+^p(_)&+ 8.6.8.1(15) ~~_P!_~~_''v~");
figs.push("-^p(_)&- 8.6.8.2(13) ~~_p!_~~_''V~");
figs.push("+^ip&+ 8.6.8.3(12) ~~_p~~_''V~");
figs.push("-^ip&- 8.6.8.4(15) ~~_P~~_''v~");
...
// 8.6.18.1-4
figs.push("+~rp(^)+ 8.6.18.1(12) ~v_''''~P!_''~");
figs.push("-~rp(^)- 8.6.18.2(15) ~V_''''~p!_''~");
figs.push("+~irp(^)+ 8.6.18.3(15) ~V_''''~p!_''~");
figs.push("-~irp(^)- 8.6.18.4(13) ~v_''''~P!_''~");
...
// 8.6.20.1-4
figs.push("+~rp(^)^- 8.6.20.1(13) ~v_''''~P!__''~");
figs.push("-~rp(^)^+ 8.6.20.2(15) ~V_''''~p!__''~");
figs.push("+~irp(^)^- 8.6.20.3(15) ~V_''''~p!__''~");
figs.push("-~irp(^)^+ 8.6.20.4(13) ~v_''''~P!__''~");

// 8.6.21.1-4
figs.push("+p(^)~- 8.6.21.1(14) ~~p!_~~''_V~");
figs.push("-p(^)~+ 8.6.21.2(14) ~~P!_~~''_v~");
figs.push("+ip(^)~- 8.6.21.3(14) ~~P!_~~''_v~");
figs.push("-ip(^)~+ 8.6.21.4(14) ~~p!_~~''_V~");

// 8.6.22.1-4
figs.push("+p(^)~+ 8.6.22.1(13) ~~p!_~~''_v~");
figs.push("-p(^)~- 8.6.22.2(15) ~~P!_~~''_V~");
figs.push("+ip(^)~+ 8.6.22.3(14) ~~P!_~~''_V~");
figs.push("-ip(^)~- 8.6.22.4(13) ~~p!_~~''_v~");
...
figs.push("+^ip(^)~- 8.6.24.3(13) ~~_p!_~~''_v~");
figs.push("-^ip(^)~+ 8.6.24.4(15) ~~_P!_~~''_V~");
