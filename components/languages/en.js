...
'aboutText' : `
  <div class="divider">
    <p>
      This&nbsp;version:&nbsp;<strong>%s</strong> &nbsp;
      Stable&nbsp;version:&nbsp;<strong>%s</strong>
    </p>
    <p>%s</p>
    <p>
      Rules&nbsp;update: <strong id="t_rulesUpdateDateTime" class="userText">This version</strong>
    </p>
    <a id="viewChangelog">View changelog.txt</a>
  </div>
  <div class="divider">
    <p>
      OpenAero is aerobatic sequence design software that
      runs inside your web browser or as an app.
    </p>
    <p>
      OpenAero is free software: you
    ...
    <p>
      OpenAero is distributed
      in the hope that it will be useful, but WITHOUT ANY WARRANTY;
      without even the implied warranty of MERCHANTABILITY or FITNESS
      FOR A PARTICULAR PURPOSE. See the GNU General Public License for
      more details.
    </p>
    <a id="privacyPolicy">View our privacy policy</a>
  </div>
  <div>
    <p>
      OpenAero is designed, built and maintained by
      <strong>Ringo Massa</strong>, using <strong>Michael Golan</strong>\'s
      OLAN sequence coding.<br>
      Many people have contributed, including:
      <table>
        <tr>
          <td><strong>Wouter Liefting</strong></td>
          <td>Figure and rule coding</td>
        </tr>
        <tr>
          <td><strong>Gilles Guillemard</strong></td>
          <td>Figure, rule and software coding</td>
        </tr>
      </table>
    </p>
  </div>`,
...
'addSequenceLink' : 'Add sequence link',
    ...
    'addWindAfterPilotCardCharacter': 'Add one of <strong>><=</strong> after ' +
        'pilot card character to choose wind direction.',
...
'noCookies' : `
  It seems data saving is disabled in your browser.
  As of 2025, OpenAero will not work without it.<br>
  See the <a href=doc/privacy.html target="_blank">privacy statement</a>
  for information on how data saving (cookies etc) are used.<br>
  To enable data saving in the Chrome browser, please copy the following
  url to your address bar:<br />
  <strong style="user-select: text;">chrome://settings/content/siteData</strong><br />
  and make sure that 'Allow sites to save data on your device' is selected.`,
...
'proposalsToGrid' : 'Load to Grid',
    ...
    'qrCode': 'QR code',
    'qrCodeTitle': 'Sequence QR code',
    'qrScanFail': 'QR scanning failed: %s',
'queue' : 'Queue',
