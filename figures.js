...
figs.push("+d_- 1.1.4.1(9) ~d~_~z~-");
figs.push("-d_+ 1.1.4.2(11) ~D~_~Z~-");
figs.push("+id_- 1.1.4.3(10) ~D~_~Z~-");
figs.push("-id_+ 1.1.4.4(9) ~d~_~z~-");
//-d_+ 1.1.4(11) = -~D~_~Z~
//+id_- 1.1.4(10) = ~D~_~Z~-
//-id_+ 1.1.4(9) = -~d~_~z~

// 1.1.5.1 through 1.1.5.4 (was 1.5.1 through 1.5.4)
figs.push("+d^+ 1.1.5.1(10) ~d~_~Z~");
figs.push("-d^- 1.1.5.2(10) ~D~_~z~");
figs.push("+id^+ 1.1.5.3(9) ~D~_~z~");
figs.push("-id^- 1.1.5.4(11) ~d~_~Z~");
//-d^- 1.1.5(10) = -~D~_~z~-
//+id^+ 1.1.5(9) = ~D~_~z~
//-id^- 1.1.5(11) = -~d~_~Z~-
...
// 1.1.8.1-4
figs.push("+z_+ 1.1.8.1(12) ~''z~_~Z''~");
figs.push("-z_- 1.1.8.2(12) ~''Z~_~z''~");
figs.push("+iz_+ 1.1.8.3(12) ~''Z~_~z''~");
figs.push("-iz_- 1.1.8.4(12) ~''z~_~Z''~");

// 1.1.9.1-4
figs.push("+z^- 1.1.9.1(11) ~''z~_~z''~");
figs.push("-z^+ 1.1.9.2(14) ~''Z~_~Z''~");
figs.push("+iz^- 1.1.9.3(14) ~''Z~_~Z''~");
figs.push("-iz^+ 1.1.9.4(11) ~''z~_~z''~");

// 1.1.10.1-4
figs.push("+z_- 1.1.10.1(9) ~''z~_~d''~");
figs.push("-z_+ 1.1.10.2(11) ~''Z~_~D''~");
figs.push("+iz_- 1.1.10.3(11) ~''Z~_~D''~");
figs.push("-iz_+ 1.1.10.4(8) ~''z~_~d''~");

// 1.1.11.1-4
figs.push("+z^+ 1.1.11.1(9) ~''z~_~D''~");
figs.push("-z^- 1.1.11.2(11) ~''Z~_~d''~");
figs.push("+iz^+ 1.1.11.3(10) ~''Z~_~d''~");
...
figs.push("+_it&+ 1.2.1.3(13) ~D~_~z~_~V~");
figs.push("-_it&- 1.2.1.4(15) ~d~_~Z~_~v~");

// 1.2.2.1-4
figs.push("+_t&- 1.2.2.1(14) ~d~_~Z~_~V~");
figs.push("-_t&+ 1.2.2.2(13) ~D~_~z~_~v~");
figs.push("+_it&- 1.2.2.3(12) ~D~_~z~_~v~");
figs.push("-_it&+ 1.2.2.4(15) ~d~_~Z~_~V~");
...
figs.push("+&ik_- 1.2.5.3(17) ~V~''_~Z~~_~~d~");
figs.push("-&ik_+ 1.2.5.4(14) ~v~''_~z~~_~~D~");
...
figs.push("+&ik^+ 1.2.7.3(16) ~V~''_~Z~~_~~D~");
...
figs.push("-&ik^+ 1.2.8.4(15) ~v~''_~Z~~_~~D~");

// 1.2.9.1-4
figs.push("+_zt&+ 1.2.9.1(15) ~~z~_~z~_~v~");
figs.push("-_zt&- 1.2.9.2(20) ~~Z~_~Z~_~V~");
figs.push("+_izt&+ 1.2.9.3(20) ~~Z~_~Z~_~V~");
figs.push("-_izt&- 1.2.9.4(16) ~~z~_~z~_~v~");

// 1.2.10.1-4
figs.push("+_zt&- 1.2.10.1(16) ~~z~_~z~_~V~");
figs.push("-_zt&+ 1.2.10.2(19) ~~Z~_~Z~_~v~");
figs.push("+_izt&- 1.2.10.3(21) ~~Z~_~Z~_~v~");
figs.push("-_izt&+ 1.2.10.4(15) ~~z~_~z~_~V~");

// 1.2.11.1-4
figs.push("+^zt&+ 1.2.11.1(19) ~~z~_~Z~_~V~");
figs.push("-^zt&- 1.2.11.2(17) ~~Z~_~z~_~v~");
figs.push("+^izt&+ 1.2.11.3(17) ~~Z~_~z~_~v~");
figs.push("-^izt&- 1.2.11.4(19) ~~z~_~Z~_~V~");

// 1.2.12.1-4
figs.push("+^zt&- 1.2.12.1(18) ~~z~_~Z~_~v~");
figs.push("-^zt&+ 1.2.12.2(18) ~~Z~_~z~_~V~");
figs.push("+^izt&- 1.2.12.3(18) ~~Z~_~z~_~V~");
figs.push("-^izt&+ 1.2.12.4(18) ~~z~_~Z~_~v~");

// 1.2.13.1-4
figs.push("+&kz_+ 1.2.13.1(16) ~v~_~z~_~z~~");
figs.push("-&kz_- 1.2.13.2(20) ~V~_~Z~_~Z~~");
figs.push("+&ikz_+ 1.2.13.3(20) ~V~_~Z~_~Z~~");
figs.push("-&ikz_- 1.2.13.4(15) ~v~_~z~_~z~~");

// 1.2.14.1-4
figs.push("+&kz_- 1.2.14.1(18) ~v~_~Z~_~Z~~");
figs.push("-&kz_+ 1.2.14.2(18) ~V~_~z~_~z~~");
figs.push("+&ikz_- 1.2.14.3(17) ~V~_~z~_~z~~");
figs.push("-&ikz_+ 1.2.14.4(19) ~v~_~Z~_~Z~~");

// 1.2.15.1-4
figs.push("+&kz^- 1.2.15.1(17) ~v~_~z~_~Z~~");
figs.push("-&kz^+ 1.2.15.2(19) ~V~_~Z~_~z~~");
figs.push("+&ikz^- 1.2.15.3(19) ~V~_~Z~_~z~~");
figs.push("-&ikz^+ 1.2.15.4(19) ~v~_~z~_~Z~~");

// 1.2.16.1-4
figs.push("+&kz^+ 1.2.16.1(17) ~v~_~Z~_~z~~");
figs.push("-&kz^- 1.2.16.2(19) ~V~_~z~_~Z~~");
figs.push("+&ikz^+ 1.2.16.3(18) ~V~_~z~_~Z~~");
...
figs.push("-_iw(&)_+ 1.3.1.4(22) ~d''_''~~Z~_~Z~~_~d~");

// 1.3.2.1-4
figs.push("+^w(&)_+ 1.3.2.1(18) ~d''_''~~z~_~z~~_~D~");
figs.push("-^w(&)_- 1.3.2.2(23) ~D''_''~~Z~_~Z~~_~d~");
figs.push("+^iw(&)_+ 1.3.2.3(22) ~D''_''~~Z~_~Z~~_~d~");
figs.push("-^iw(&)_- 1.3.2.4(19) ~d''_''~~z~_~z~~_~D~");

// 1.3.3.1-4
figs.push("+_w(&)^+ 1.3.3.1(22) ~d''_''~~Z~_~Z~~_~D~");
figs.push("-_w(&)^- 1.3.3.2(19) ~D''_''~~z~_~z~~_~d~");
figs.push("+_iw(&)^+ 1.3.3.3(18) ~D''_''~~z~_~z~~_~d~");
figs.push("-_iw(&)^- 1.3.3.4(23) ~d''_''~~Z~_~Z~~_~D~");

// 1.3.4.1-4
figs.push("+^w(&)^- 1.3.4.1(18) ~d''_''~~z~_~z~~_~d~");
figs.push("-^w(&)^+ 1.3.4.2(23) ~D''_''~~Z~_~Z~~_~D~");
figs.push("+^iw(&)^- 1.3.4.3(23) ~D''_''~~Z~_~Z~~_~D~");
figs.push("-^iw(&)^+ 1.3.4.4(18) ~d''_''~~z~_~z~~_~d~");

// 1.3.5.1-4
figs.push("+_w(&)_+ 1.3.5.1(20) ~d''_''~~Z~_~z~~_~D~");
figs.push("-_w(&)_- 1.3.5.2(21) ~D''_''~~z~_~Z~~_~d~");
figs.push("+_iw(&)_+ 1.3.5.3(19) ~D''_''~~z~_~Z~~_~d~");
figs.push("-_iw(&)_- 1.3.5.4(22) ~d''_''~~Z~_~z~~_~D~");

// 1.3.6.1-4
figs.push("+^w(&)_- 1.3.6.1(20) ~d''_''~~z~_~Z~~_~d~");
figs.push("-^w(&)_+ 1.3.6.2(21) ~D''_''~~Z~_~z~~_~D~");
figs.push("+^iw(&)_- 1.3.6.3(21) ~D''_''~~Z~_~z~~_~D~");
figs.push("-^iw(&)_+ 1.3.6.4(19) ~d''_''~~z~_~Z~~_~d~");

// 1.3.7.1-4
figs.push("+_w(&)^- 1.3.7.1(20) ~d''_''~~Z~_~z~~_~d~");
figs.push("-_w(&)^+ 1.3.7.2(21) ~D''_''~~z~_~Z~~_~D~");
figs.push("+_iw(&)^- 1.3.7.3(20) ~D''_''~~z~_~Z~~_~D~");
figs.push("-_iw(&)^+ 1.3.7.4(20) ~d''_''~~Z~_~z~~_~d~");

// 1.3.8.1-4
figs.push("+^w(&)^+ 1.3.8.1(20) ~d''_''~~z~_~Z~~_~D~");
figs.push("-^w(&)^- 1.3.8.2(21) ~D''_''~~Z~_~z~~_~d~");
figs.push("+^iw(&)^+ 1.3.8.3(20) ~D''_''~~Z~_~z~~_~d~");
...
figs.push("-&pn(_)&+ 1.3.10.2(24) -~V~_''~Z~~_~z~''_~V~");
figs.push("+&ipn(_)&- 1.3.10.3(24) ~V~_''~Z~~_~z~''_~V~");
figs.push("-&in(_)&+ 1.3.10.4(22) -~v~_''~z~~_~Z~''_~v~");

// 1.3.11.1-4
figs.push("+&n(^)&- 1.3.11.1(20) ~v~_''~z~~_~z~''_~v~");
figs.push("-&pn(^)&+ 1.3.11.2(27) -~V~_''~Z~~_~Z~''_~V~");
figs.push("+&ipn(^)&- 1.3.11.3(26) ~V~_''~Z~~_~Z~''_~V~");
figs.push("-&in(^)&+ 1.3.11.4(20) -~v~_''~z~~_~z~''_~v~");

// 1.3.12.1-4
figs.push("+&n(^)&+ 1.3.12.1(21) ~v~_''~z~~_~z~''_~V~");
figs.push("-&pn(^)&- 1.3.12.2(26) -~V~_''~Z~~_~Z~''_~v~");
figs.push("+&ipn(^)&+ 1.3.12.3(25) ~V~_''~Z~~_~Z~''_~v~");
figs.push("-&in(^)&- 1.3.12.4(21) -~v~_''~z~~_~z~''_~V~");

// 1.3.13-1.4
figs.push("+&pn(_)&+ 1.3.13.1(22) ~v~_''~Z~~_~z~''_~V~");
figs.push("-&n(_)&- 1.3.13.2(25) -~V~_''~z~~_~Z~''_~v~");
figs.push("+&in(_)&+ 1.3.13.3(23) ~V~_''~z~~_~Z~''_~v~");
figs.push("-&ipn(_)&- 1.3.13.4(23) -~v~_''~Z~~_~z~''_~V~");
...
// 1.3.15.1-4
figs.push("+&pn(^)&- 1.3.15.1(24) ~v~_''~Z~~_~Z~''_~v~");
figs.push("-&n(^)&+ 1.3.15.2(23) -~V~_''~z~~_~z~''_~V~");
figs.push("+&in(^)&- 1.3.15.3(22) ~V~_''~z~~_~z~''_~V~");
figs.push("-&ipn(^)&+ 1.3.15.4(23) -~v~_''~Z~~_~Z~''_~v~");

// 1.3.16.1-4
figs.push("+&pn(^)&+ 1.3.16.1(25) ~v~_''~Z~~_~Z~''_~V~");
figs.push("-&n(^)&- 1.3.16.2(22) -~V~_''~z~~_~z~''_~v~");
figs.push("+&in(^)&+ 1.3.16.3(21) ~V~_''~z~~_~z~''_~v~");
figs.push("-&ipn(^)&- 1.3.16.4(25) -~v~_''~Z~~_~Z~''_~V~");
...
figs.push("+2jio51- 2.2.7.1(26:40) ~''jio251''~");
figs.push("-2jio51+ 2.2.7.2(26:40) ~''JIO251''~");
...
// 2.4.2.1-4 (1 roll)
figs.push("+4j1+ 2.4.2.1(46) ~''j41''~");
figs.push("-4j1- 2.4.2.2(47) ~''J41''~");
figs.push("+4jo1+ 2.4.2.3(50) ~''J41''~");
figs.push("-4jo1- 2.4.2.4(51) ~''j41''~");
...
// 3.4.1.1-4
figs.push("+dvz- 3.4.1.1(10) ~d~d~d~d~");
figs.push("-dvz+ 3.4.1.2(13) ~D~D~D~D~");
figs.push("+idvz- 3.4.1.3(12) ~D~D~D~D~");
figs.push("-idvz+ 3.4.1.4(10) ~d~d~d~d~");

// 3.4.2.1-4
figs.push("+dvd+ 3.4.2.1(11) ~d~d~D~D~");
figs.push("-dvd- 3.4.2.2(12) ~D~D~d~d~");
figs.push("+idvd+ 3.4.2.3(11) ~D~D~d~d~");
figs.push("-idvd- 3.4.2.4(12) ~d~d~D~D~");

// Family 3.8 Eight Corners

// 3.8.1.1-4
figs.push("+rqq- 3.8.1.1(22) ~d~d~D~D~D~D~D~D~");
figs.push("-rqq+ 3.8.1.2(23) ~D~D~d~d~d~d~d~d~");
figs.push("+irqq- 3.8.1.3(22) ~D~D~d~d~d~d~d~d~");
figs.push("-irqq+ 3.8.1.4(23) ~d~d~D~D~D~D~D~D~");
...
figs.push("-_dh(&)&- 5.3.1.2(25) ~D~_~D~_~H~_''V~");
figs.push("+_dh(&)&- 5.3.1.3(20) ~d~_~d~_~h~_''V~");
figs.push("-_dh(&)&+ 5.3.1.4(23) ~D~_~D~_~H~_''v~");

// 5.3.2.1-4
figs.push("+^dh(&)&+ 5.3.2.1(24) ~d~_~D~_~h~_''v~");
figs.push("-^dh(&)&- 5.3.2.2(22) ~D~_~d~_~H~_''V~");
figs.push("+^dh(&)&- 5.3.2.3(25) ~d~_~D~_~h~_''V~");
figs.push("-^dh(&)&+ 5.3.2.4(21) ~D~_~d~_~H~_''v~");

// 5.3.3.1-4
figs.push("+&hd(&)_+ 5.3.3.1(18) ~v~_~h~_''d~_~d~");
figs.push("-&hd(&)_- 5.3.3.2(24) ~V~_~H~_''D~_~D~");
figs.push("+&hd(&)_- 5.3.3.3(20) ~v~_~h~_''D~_~D~");
figs.push("-&hd(&)_+ 5.3.3.4(23) ~V~_~H~_''d~_~d~");

// 5.3.4.1-4
figs.push("+&hd(&)^+ 5.3.4.1(20) ~v~_~h~_''D~_~d~");
figs.push("-&hd(&)^- 5.3.4.2(25) ~V~_~H~_''d~_~D~");
figs.push("+&hd(&)^- 5.3.4.3(20) ~v~_~h~_''d~_~D~");
...
figs.push("-_dhd(&)(&)_- 5.4.1.2(26) ~D~_~D~_~H~_''D~_~D~");
figs.push("+_dhd(&)(&)_- 5.4.1.3(21) ~d~_~d~_~h~_''D~_~D~");
figs.push("-_dhd(&)(&)_+ 5.4.1.4(24) ~D~_~D~_~H~_''d~_~d~");

// 5.4.2.1-4
figs.push("+_dhd(&)(&)^+ 5.4.2.1(21) ~d~_~d~_~h~_''D~_~d~");
figs.push("-_dhd(&)(&)^- 5.4.2.2(27) ~D~_~D~_~H~_''d~_~D~");
figs.push("+_dhd(&)(&)^- 5.4.2.3(22) ~d~_~d~_~h~_''d~_~D~");
figs.push("-_dhd(&)(&)^+ 5.4.2.4(26) ~D~_~D~_~H~_''D~_~d~");

// 5.4.3.1-4
figs.push("+^dhd(&)(&)_+ 5.4.3.1(25) ~d~_~D~_~h~_''d~_~d~");
figs.push("-^dhd(&)(&)_- 5.4.3.2(23) ~D~_~d~_~H~_''D~_~D~");
figs.push("+^dhd(&)(&)_- 5.4.3.3(26) ~d~_~D~_~h~_''D~_~D~");
figs.push("-^dhd(&)(&)_+ 5.4.3.4(22) ~D~_~d~_~H~_''d~_~d~");

// 5.4.4.1-4
figs.push("+^dhd(&)(&)^+ 5.4.4.1(27) ~d~_~D~_~h~_''D~_~d~");
figs.push("-^dhd(&)(&)^- 5.4.4.2(24) ~D~_~d~_~H~_''d~_~D~");
figs.push("+^dhd(&)(&)^- 5.4.4.3(27) ~d~_~D~_~h~_''d~_~D~");
figs.push("-^dhd(&)(&)^+ 5.4.4.4(24) ~D~_~d~_~H~_''D~_~d~");
...
figs.push("+iqq+ 7.4.6.3(24) ~~D~D~D~D~D~D~D~D~~");
figs.push("-iqq- 7.4.6.4(19) ~~d~d~d~d~d~d~d~d~~");
...
figs.push("-mm- 7.5.9.2(13) ~~Mm~~");
figs.push("+imm+ 7.5.9.3(12) ~~Mm~~");
figs.push("-imm- 7.5.9.4(13) ~~mM~~");

// 7.5.10.1-4
figs.push("+mm^- 7.5.10.1(10) ~~m_m~~");
figs.push("-mm^+ 7.5.10.2(14) ~~M_M~~");
figs.push("+imm^- 7.5.10.3(14) ~~M_M~~");
...
figs.push("-oo- 7.8.17.2(23) ~MoM~");
figs.push("+ioo+ 7.8.17.3(22) ~MoM~");
figs.push("-ioo- 7.8.17.4(23) ~mOm~");

// 7.8.18.1-4
figs.push("+^oo- 7.8.18.1(20) ~m_oM~");
figs.push("-^oo+ 7.8.18.2(24) ~M_Om~");
figs.push("+^ioo- 7.8.18.3(24) ~M_Om~");
figs.push("-^ioo+ 7.8.18.4(20) ~m_oM~");

// 7.8.19.1-4
figs.push("+oo^- 7.8.19.1(24) ~mO_M~");
figs.push("-oo^+ 7.8.19.2(20) ~Mo_m~");
figs.push("+ioo^- 7.8.19.3(20) ~Mo_m~");
figs.push("-ioo^+ 7.8.19.4(24) ~mO_M~");

// 7.8.20.1-4
figs.push("+^oo^+ 7.8.20.1(18) ~m_o_m~");
figs.push("-^oo^- 7.8.20.2(27) ~M_O_M~");
figs.push("+^ioo^+ 7.8.20.3(26) ~M_O_M~");
figs.push("-^ioo^- 7.8.20.4(19) ~m_o_m~");

// 7.8.21.1-4
figs.push("+ooo+ 7.8.21.1(22) ~oO~");
figs.push("-ooo- 7.8.21.2(23) ~Oo~");
figs.push("+iooo+ 7.8.21.3(22) ~O''o~");
figs.push("-iooo- 7.8.21.4(23) ~o''O~");

// 7.8.22.1-4
figs.push("+ooo^+ 7.8.22.1(18) ~o_o~");
figs.push("-ooo^- 7.8.22.2(26) ~O_O~");
figs.push("+iooo^+ 7.8.22.3(26) ~O_''O~");
figs.push("-iooo^- 7.8.22.4(18) ~o_''o~");
...
figs.push("-_bz_- 8.4.5.2(17) ~~~D~''_''M~''_~~Z~~~~");
figs.push("+_ibz_+ 8.4.5.3(17) ~~~D~''_''M~''_~~Z~~~~");
figs.push("-_ibz_- 8.4.5.4(13) ~~~d~''_''m~''_~~z~~~~");

// 8.4.6.1-4
figs.push("+_bz^- 8.4.6.1(15) ~~~d~''_''m~''_~~Z~~~~");
figs.push("-_bz^+ 8.4.6.2(17) ~~~D~''_''M~''_~~z~~~~");
figs.push("+_ibz^- 8.4.6.3(17) ~~~D~''_''M~''_~~z~~~~");
figs.push("-_ibz^+ 8.4.6.4(16) ~~~d~''_''m~''_~~Z~~~~");

// 8.4.7.1-4
figs.push("+^rbz_- 8.4.7.1(16) ~d~~_''m''_''~Z~~");
figs.push("-^rbz_+ 8.4.7.2(17) ~D~~_''M''_''~z~~");
figs.push("+^irbz_- 8.4.7.3(16) ~D~~_''M''_''~z~~");
figs.push("-^irbz_+ 8.4.7.4(16) ~d~~_''m''_''~Z~~");

// 8.4.8.1-4
figs.push("+^rbz^+ 8.4.8.1(15) ~d~~_''m''_''~z~~");
figs.push("-^rbz^- 8.4.8.2(20) ~D~~_''M''_''~Z~~");
figs.push("+^irbz^+ 8.4.8.3(19) ~D~~_''M''_''~Z~~");
figs.push("-^irbz^- 8.4.8.4(16) ~d~~_''m''_''~z~~");

// 8.4.9.1-4
figs.push("+_rbz_+ 8.4.9.1(15) ~d~~_''M''_''~z~~");
figs.push("-_rbz_- 8.4.9.2(15) ~D~~_''m''_''~Z~~");
figs.push("+_irbz_+ 8.4.9.3(15) ~D~~_''m''_''~Z~~");
figs.push("-_irbz_- 8.4.9.4(15) ~d~~_''M''_''~z~~");

// 8.4.10.1-4
figs.push("+_rbz^- 8.4.10.1(17) ~d~~_''M''_''~Z~~");
figs.push("-_rbz^+ 8.4.10.2(15) ~D~~_''m''_''~z~~");
figs.push("+_irbz^- 8.4.10.3(15) ~D~~_''m''_''~z~~");
figs.push("-_irbz^+ 8.4.10.4(18) ~d~~_''M''_''~Z~~");

// 8.4.11.1-4
figs.push("+^bz_- 8.4.11.1(18) ~~~d~''_''M~''_~~Z~~~~");
figs.push("-^bz_+ 8.4.11.2(15) ~~~D~''_''m~''_~~z~~~~");
figs.push("+^ibz_- 8.4.11.3(14) ~~~D~''_''m~''_~~z~~~~");
figs.push("-^ibz_+ 8.4.11.4(18) ~~~d~''_''M~''_~~Z~~~~");

// 8.4.12.1-4
figs.push("+^bz^+ 8.4.12.1(17) ~~~d~''_''M~''_~~z~~~~");
figs.push("-^bz^- 8.4.12.2(18) ~~~D~''_''m~''_~~Z~~~~");
figs.push("+^ibz^+ 8.4.12.3(17) ~~~D~''_''m~''_~~Z~~~~");
figs.push("-^ibz^- 8.4.12.4(18) ~~~d~''_''M~''_~~z~~~~");
...
// 8.4.21.1-4
figs.push("+_zb_+ 8.4.21.1(13) ~~~~z~''_''~m''_''~d''~");
figs.push("-_zb_- 8.4.21.2(17) ~~~~Z~''_''~M''_''~D''~");
figs.push("+_izb_+ 8.4.21.3(17) ~~~~Z~''_''~M''_''~D''~");
figs.push("-_izb_- 8.4.21.4(13) ~~~~z~''_''~m''_''~d''~");

// 8.4.22.1-4
figs.push("+_zb^- 8.4.22.1(15) ~~~~z~''_''~m''_''~D''~");
figs.push("-_zb^+ 8.4.22.2(17) ~~~~Z~''_''~M''_''~d''~");
figs.push("+_izb^- 8.4.22.3(18) ~~~~Z~''_''~M''_''~d''~");
figs.push("-_izb^+ 8.4.22.4(15) ~~~~z~''_''~m''_''~D''~");

// 8.4.23.1-4
figs.push("+^rzb_- 8.4.23.1(15) ~~z~''_''m~''_''~D''");
figs.push("-^rzb_+ 8.4.23.2(18) ~~Z~''_''M~''_''~d''");
figs.push("+^irzb_- 8.4.23.3(18) ~~Z~''_''M~''_''~d''");
figs.push("-^irzb_+ 8.4.23.4(14) ~~z~''_''m~''_''~D''");

// 8.4.24.1-4
figs.push("+^rzb^+ 8.4.24.1(15) ~~z~''_''m~''_''~d''");
figs.push("-^rzb^- 8.4.24.2(20) ~~Z~''_''M~''_''~D''");
figs.push("+^irzb^+ 8.4.24.3(19) ~~Z~''_''M~''_''~D''");
figs.push("-^irzb^- 8.4.24.4(16) ~~z~''_''m~''_''~d''");

// 8.4.25.1-4
figs.push("+_rzb_+ 8.4.25.1(15) ~~z~''_''M~''_''~d''");
figs.push("-_rzb_- 8.4.25.2(15) ~~Z~''_''m~''_''~D''");
figs.push("+_irzb_+ 8.4.25.3(15) ~~Z~''_''m~''_''~D''");
figs.push("-_irzb_- 8.4.25.4(15) ~~z~''_''M~''_''~d''");

// 8.4.26.1-4
figs.push("+_rzb^- 8.4.26.1(17) ~~z~''_''M~''_''~D''");
figs.push("-_rzb^+ 8.4.26.2(15) ~~Z~''_''m~''_''~d''");
figs.push("+_irzb^- 8.4.26.3(16) ~~Z~''_''m~''_''~d''");
figs.push("-_irzb^+ 8.4.26.4(17) ~~z~''_''M~''_''~D''");

// 8.4.27.1-4
figs.push("+^zb_- 8.4.27.1(17) ~~~~z~''_''~M''_''~D''~");
figs.push("-^zb_+ 8.4.27.2(16) ~~~~Z~''_''~m''_''~d''~");
figs.push("+^izb_- 8.4.27.3(16) ~~~~Z~''_''~m''_''~d''~");
figs.push("-^izb_+ 8.4.27.4(16) ~~~~z~''_''~M''_''~D''~");

// 8.4.28.1-4
figs.push("+^zb^+ 8.4.28.1(17) ~~~~z~''_''~M''_''~d''~");
figs.push("-^zb^- 8.4.28.2(18) ~~~~Z~''_''~m''_''~D''~");
figs.push("+^izb^+ 8.4.28.3(17) ~~~~Z~''_''~m''_''~D''~");
...
// 8.5.13.1-4
figs.push("+_zy&+ 8.5.13.1(17) ~z~''_''C~_~~v~");
figs.push("-_zy&- 8.5.13.2(17) ~Z~''_''c~_~~V~");
figs.push("+_izy&+ 8.5.13.3(17) ~Z~''_''c~_~~V~");
figs.push("-_izy&- 8.5.13.4(18) ~z~''_''C~_~~v~");

// 8.5.14.1-4
figs.push("+_zy&- 8.5.14.1(19) ~z~''_''C~_~~V~");
figs.push("-_zy&+ 8.5.14.2(16) ~Z~''_''c~_~~v~");
figs.push("+_izy&- 8.5.14.3(17) ~Z~''_''c~_~~v~");
figs.push("-_izy&+ 8.5.14.4(19) ~z~''_''C~_~~V~");

// 8.5.15.1-4
figs.push("+^zy&+ 8.5.15.1(16) ~z~''_''c~_~~v~");
figs.push("-^zy&- 8.5.15.2(22) ~Z~''_''C~_~~V~");
figs.push("+^izy&+ 8.5.15.3(21) ~Z~''_''C~_~~V~");
figs.push("-^izy&- 8.5.15.4(16) ~z~''_''c~_~~v~");

// 8.5.16.1-4
figs.push("+^zy&- 8.5.16.1(17) ~z~''_''c~_~~V~");
figs.push("-^zy&+ 8.5.16.2(20) ~Z~''_''C~_~~v~");
figs.push("+^izy&- 8.5.16.3(20) ~Z~''_''C~_~~v~");
figs.push("-^izy&+ 8.5.16.4(17) ~z~''_''c~_~~V~");
...
// 8.5.21.1-4
figs.push("+&ryz_- 8.5.21.1(16) ~~v~~_~c~_~Z~");
figs.push("-&ryz_+ 8.5.21.2(19) ~~V~~_~C~_~z~");
figs.push("+&iryz_- 8.5.21.3(18) ~~V~~_~C~_~z~");
figs.push("-&iryz_+ 8.5.21.4(16) ~~v~~_~c~_~Z~");

// 8.5.22.1-4
figs.push("+&ryz^+ 8.5.22.1(16) ~~v~~_~c~_~z~");
figs.push("-&ryz^- 8.5.22.2(22) ~~V~~_~C~_~Z~");
figs.push("+&iryz^+ 8.5.22.3(21) ~~V~~_~C~_~Z~");
figs.push("-&iryz^- 8.5.22.4(16) ~~v~~_~c~_~z~");

// 8.5.23.1-4
figs.push("+&ryz_+ 8.5.23.1(17) ~~v~~_~C~_~z~");
figs.push("-&ryz_- 8.5.23.2(18) ~~V~~_~c~_~Z~");
figs.push("+&iryz_+ 8.5.23.3(17) ~~V~~_~c~_~Z~");
figs.push("-&iryz_- 8.5.23.4(17) ~~v~~_~C~_~z~");

// 8.5.24.1-4
figs.push("+&ryz^- 8.5.24.1(20) ~~v~~_~C~_~Z~");
figs.push("-&ryz^+ 8.5.24.2(17) ~~V~~_~c~_~z~");
figs.push("+&iryz^- 8.5.24.3(17) ~~V~~_~c~_~z~");
...
figs.push("+&irp(_)_+ 8.6.1.3(15) ~V''_''~P!__''~");
figs.push("-&irp(_)_- 8.6.1.4(12) ~v''_''~p!__''~");

// 8.6.2.1-4
figs.push("+&rp(_)^- 8.6.2.1(12) ~v~_~~p!__''~");
figs.push("-&rp(_)^+ 8.6.2.2(16) ~V~_~~P!__''~");
figs.push("+&irp(_)^- 8.6.2.3(16) ~V~_~~P!__''~");
figs.push("-&irp(_)^+ 8.6.2.4(12) ~v~_~~p!__''~");

// 8.6.3.1-4
figs.push("+&rp(_)_- 8.6.3.1(15) ~v''_''~P!__''~");
figs.push("-&rp(_)_+ 8.6.3.2(13) ~V''_''~p!__''~");
figs.push("+&irp(_)_- 8.6.3.3(13) ~V''_''~p!__''~");
figs.push("-&irp(_)_+ 8.6.3.4(14) ~v''_''~P!__''~");

// 8.6.4.1-4
figs.push("+&rp(_)^+ 8.6.4.1(14) ~v~_~~P!__''~");
figs.push("-&rp(_)^- 8.6.4.2(13) ~V~_~~p!__''~");
figs.push("+&irp(_)^+ 8.6.4.3(13) ~V~_~~p!__''~");
figs.push("-&irp(_)^- 8.6.4.4(15) ~v~_~~P!__''~");

// 8.6.5.1-4
figs.push("+_p(_)&+ 8.6.5.1(11) ~~_p!_~~_''v~");
figs.push("-_p(_)&- 8.6.5.2(16) ~~_P!_~~_''V~");
figs.push("+_ip(_)&+ 8.6.5.3(16) ~~_P!_~~_''V~");
figs.push("-_ip(_)&- 8.6.5.4(12) ~~_p!_~~_''v~");

// 8.6.6.1-4
figs.push("+_p(_)&- 8.6.6.1(12) ~~_p!_~~_''V~");
figs.push("-_p(_)&+ 8.6.6.2(15) ~~_P!_~~_''v~");
figs.push("+_ip(_)&- 8.6.6.3(15) ~~_P!_~~_''v~");
figs.push("-_ip(_)&+ 8.6.6.4(13) ~~_p!_~~_''V~");

// 8.6.7.1-4
figs.push("+^p(_)&- 8.6.7.1(16) ~~_P!_~~_''V~");
figs.push("-^p(_)&+ 8.6.7.2(12) ~~_p!_~~_''v~");
figs.push("+^ip(_)&- 8.6.7.3(12) ~~_p!_~~_''v~");
figs.push("-^ip(_)&+ 8.6.7.4(16) ~~_P!_~~_''V~");

// 8.6.8.1-4
figs.push("+^p(_)&+ 8.6.8.1(15) ~~_P!_~~_''v~");
figs.push("-^p(_)&- 8.6.8.2(13) ~~_p!_~~_''V~");
figs.push("+^ip(_)&+ 8.6.8.3(12) ~~_p!_~~_''V~");
figs.push("-^ip(_)&- 8.6.8.4(15) ~~_P!_~~_''v~");
...
figs.push("+&irpp(_)_- 8.6.9.3(15) ~~~~V~_~M!_v=_~-");
figs.push("-&irpp(_)_+ 8.6.9.4(13) ~~~~v~_~m!_V=_~-");

// 8.6.10.1-4
figs.push("+&rpp(_)^+ 8.6.10.1(12) ~~~~v~_~m!_V=_~");
figs.push("-&rpp(_)^- 8.6.10.2(15) ~~~~V~_~M!_v=_~");
figs.push("+&irpp(_)^+ 8.6.10.3(14) ~~~~V~_~M!_v=_~");
figs.push("-&irpp(_)^- 8.6.10.4(14) ~~~~v~_~m!_V=_~");

// 8.6.11.1-4
figs.push("+&rpp(_)_+ 8.6.11.1(13) ~v~_~M!_v=_~");
figs.push("-&rpp(_)_- 8.6.11.2(14) ~V~_~m!_V=_~");
figs.push("+&irpp(_)_+ 8.6.11.3(13) ~V~_~m!_V=_~");
figs.push("-&irpp(_)_- 8.6.11.4(14) ~v~_~M!_v=_~");

// 8.6.12.1-4
figs.push("+&rpp(_)^- 8.6.12.1(14) ~v~_~M!_v=_~-");
figs.push("-&rpp(_)^+ 8.6.12.2(14) ~V~_~m!_V=_~-");
figs.push("+&irpp(_)^- 8.6.12.3(14) ~V~_~m!_V=_~-");
figs.push("-&irpp(_)^+ 8.6.12.4(13) ~v~_~M!_v=_~-");

// 8.6.13.1-4
figs.push("+_pp(_)&+ 8.6.13.1(13) ~_v=M!_~_~v~");
figs.push("-_pp(_)&- 8.6.13.2(14) ~_V=m!_~_~V~");
figs.push("+_ipp(_)&+ 8.6.13.3(13) ~_V=m!_~_~V~");
figs.push("-_ipp(_)&- 8.6.13.4(14) ~_v=M!_~_~v~");

// 8.6.14.1-4
figs.push("+_pp(_)&- 8.6.14.1(15) ~_v=M!_~_~V~-");
figs.push("-_pp(_)&+ 8.6.14.2(12) ~_V=m!_~_~v~-");
figs.push("+_ipp(_)&- 8.6.14.3(13) ~_V=m!_~_~v~-");
figs.push("-_ipp(_)&+ 8.6.14.4(15) ~_v=M!_~_~V~-");

// 8.6.15.1-4
figs.push("+^pp(_)&- 8.6.15.1(13) ~_V=m!_~_~V~");
figs.push("-^pp(_)&+ 8.6.15.2(14) ~_v=M!_~_~v~");
figs.push("+^ipp(_)&- 8.6.15.3(14) ~_v=M!_~_~v~");
figs.push("-^ipp(_)&+ 8.6.15.4(14) ~_V=m!_~_~V~");
...
// 8.6.17.1-4
figs.push("+rp(^)- 8.6.17.1(14:0) ~v''''~p!_''~");
figs.push("-rp(^)+ 8.6.17.2(14:0) ~V''''~P!_''~");
figs.push("+irp(^)- 8.6.17.3(14:0) ~V''''~P!_''~");
figs.push("-irp(^)+ 8.6.17.4(14:0) ~v''''~p!_''~");
...
// 8.6.18.1-4
figs.push("+rp(^)^+ 8.6.18.1(13:0) ~v''''~p!__''~");
figs.push("-rp(^)^- 8.6.18.2(14:0) ~V''''~P!__''~");
figs.push("+irp(^)^+ 8.6.18.3(14:0) ~V''''~P!__''~");
figs.push("-irp(^)^- 8.6.18.4(14:0) ~v''''~p!__''~");
...
// 8.6.19.1-4
figs.push("+rp(^)+ 8.6.19.1(12:0) ~v''''~P!_''~");
figs.push("-rp(^)- 8.6.19.2(15:0) ~V''''~p!_''~");
figs.push("+irp(^)+ 8.6.19.3(15:0) ~V''''~p!_''~");
figs.push("-irp(^)- 8.6.19.4(13:0) ~v''''~P!_''~");

// 8.6.20.1-4
figs.push("+rp(^)^- 8.6.20.1(13:0) ~v''''~P!__''~");
figs.push("-rp(^)^+ 8.6.20.2(15:0) ~V''''~p!__''~");
figs.push("+irp(^)^- 8.6.20.3(15:0) ~V''''~p!__''~");
figs.push("-irp(^)^+ 8.6.20.4(13:0) ~v''''~P!__''~");

// 8.6.21.1-4
figs.push("+p(^)- 8.6.21.1(14:0) ~~p!_~~''V~");
figs.push("-p(^)+ 8.6.21.2(14:0) ~~P!_~~''v~");
figs.push("+ip(^)- 8.6.21.3(14:0) ~~P!_~~''v~");
figs.push("-ip(^)+ 8.6.21.4(14:0) ~~p!_~~''V~");

// 8.6.22.1-4
figs.push("+p(^)+ 8.6.22.1(13:0) ~~p!_~~''v~");
figs.push("-p(^)- 8.6.22.2(15:0) ~~P!_~~''V~");
figs.push("+ip(^)+ 8.6.22.3(14:0) ~~P!_~~''V~");
figs.push("-ip(^)- 8.6.22.4(13:0) ~~p!_~~''v~");

// 8.6.23.1-4
figs.push("+^p(^)+ 8.6.23.1(13:0) ~~_P!_~~''v~");
figs.push("-^p(^)- 8.6.23.2(14:0) ~~_p!_~~''V~");
figs.push("+^ip(^)+ 8.6.23.3(14:0) ~~_p!_~~''V~");
figs.push("-^ip(^)- 8.6.23.4(14:0) ~~_P!_~~''v~");

// 8.6.24.1-4
figs.push("+^p(^)- 8.6.24.1(15:0) ~~_P!_~~''V~");
figs.push("-^p(^)+ 8.6.24.2(13:0) ~~_p!_~~''v~");
figs.push("+^ip(^)- 8.6.24.3(13:0) ~~_p!_~~''v~");
figs.push("-^ip(^)+ 8.6.24.4(15:0) ~~_P!_~~''V~");
...
figs.push("-_rq(_)_- 8.7.1.2(16) ~D''_''~R!__~~");
figs.push("+_irq(_)_+ 8.7.1.3(15) ~D''_''~R!__~~");
figs.push("-_irq(_)_- 8.7.1.4(12) ~d''_''~r!__~~");

// 8.7.2.1-4
figs.push("+^rq(_)_- 8.7.2.1(17) ~d''_''~R!__~~");
figs.push("-^rq(_)_+ 8.7.2.2(14) ~D''_''~r!__~~");
figs.push("+^irq(_)_- 8.7.2.3(13) ~D''_''~r!__~~");
figs.push("-^irq(_)_+ 8.7.2.4(16) ~d''_''~R!__~~");

// 8.7.3.1-4
figs.push("+_rq(_)^- 8.7.3.1(12) ~d''_''~r!__~~");
figs.push("-_rq(_)^+ 8.7.3.2(16) ~D''_''~R!__~~");
figs.push("+_irq(_)^- 8.7.3.3(15) ~D''_''~R!__~~");
figs.push("-_irq(_)^+ 8.7.3.4(12) ~d''_''~r!__~~");

// 8.7.4.1-4
figs.push("+^rq(_)^+ 8.7.4.1(16) ~d''_''~R!__~~");
figs.push("-^rq(_)^- 8.7.4.2(14) ~D''_''~r!__~~");
figs.push("+^irq(_)^+ 8.7.4.3(13) ~D''_''~r!__~~");
figs.push("-^irq(_)^- 8.7.4.4(17) ~d''_''~R!__~~");

// 8.7.5.1-4
figs.push("+_q(_)_+ 8.7.5.1(11) ~~_r!_~~_''d~");
figs.push("-_q(_)_- 8.7.5.2(16) ~~_R!_~~_''D~");
figs.push("+_iq(_)_+ 8.7.5.3(15) ~~_R!_~~_''D~");
figs.push("-_iq(_)_- 8.7.5.4(12) ~~_r!_~~_''d~");

// 8.7.6.1-4
figs.push("+_q(_)^- 8.7.6.1(13) ~~_r!_~~_''D~");
figs.push("-_q(_)^+ 8.7.6.2(16) ~~_R!_~~_''d~");
figs.push("+_iq(_)^- 8.7.6.3(17) ~~_R!_~~_''d~");
figs.push("-_iq(_)^+ 8.7.6.4(14) ~~_r!_~~_''D~");

// 8.7.7.1-4
figs.push("+^q(_)_- 8.7.7.1(16) ~~_R!_~~_''D~");
figs.push("-^q(_)_+ 8.7.7.2(11) ~~_r!_~~_''d~");
figs.push("+^iq(_)_- 8.7.7.3(12) ~~_r!_~~_''d~");
figs.push("-^iq(_)_+ 8.7.7.4(16) ~~_R!_~~_''D~");

// 8.7.8.1-4
figs.push("+^q(_)^+ 8.7.8.1(16) ~~_R!_~~_''d~");
figs.push("-^q(_)^- 8.7.8.2(14) ~~_r!_~~_''D~");
figs.push("+^iq(_)^+ 8.7.8.3(13) ~~_r!_~~_''D~");
figs.push("-^iq(_)^- 8.7.8.4(17) ~~_R!_~~_''d~");

// Family 8.8. Double bumps
// New for 2012 - coded by Ringo Massa and Wouter Liefting
// bb = pull, pull
// pbb = push, pull
// bpb = pull, push
// pbpb = push, push
...
figs.push("v3 9.1.1.3(10:15)");
figs.push("v1 9.1.1.4(12:18)");
figs.push("v5 9.1.1.5(14)");
figs.push("v6 9.1.1.6(15)");
figs.push("v7 9.1.1.7(17)");
figs.push("v9 9.1.1.8(18)");
figs.push("d4 9.1.2.1(4:6)");
figs.push("d2 9.1.2.2(6:9)");
figs.push("d3 9.1.2.3(8:12)");
figs.push("d1 9.1.2.4(10:15)");
figs.push("d5 9.1.2.5(11)");
figs.push("d6 9.1.2.6(12:18)");
figs.push("d7 9.1.2.7(14)");
figs.push("d9 9.1.2.8(15)");
...
figs.push("id5 9.1.4.5(9)");
figs.push("id6 9.1.4.6(10:15)");
figs.push("id7 9.1.4.7(11)");
figs.push("id9 9.1.4.8(12)");
figs.push("iv4 9.1.5.1(2:3)");
figs.push("iv2 9.1.5.2(4:6)");
figs.push("iv3 9.1.5.3(6:9)");
figs.push("iv1 9.1.5.4(8:12)");
figs.push("iv5 9.1.5.5(9)");
figs.push("iv6 9.1.5.6(10)");
figs.push("iv7 9.1.5.7(11)");
figs.push("iv9 9.1.5.8(12)");

// 22    23     24 
figs.push("v22 9.2.1.4(13:20)");
figs.push("v32 9.2.1.6(17)");
figs.push("v42 9.2.1.8(21)");
figs.push("d22 9.2.2.4(11:17)");
figs.push("d32 9.2.2.6(14)");
figs.push("d42 9.2.2.8(18)");
figs.push("22 9.2.3.4(9:14)");
figs.push("32 9.2.3.6(12:18)");
figs.push("42 9.2.3.8(15:23)");
figs.push("id22 9.2.4.4(9:14)");
figs.push("id32 9.2.4.6(12:18)");
figs.push("id42 9.2.4.8(15)");
figs.push("iv22 9.2.5.4(9:14)");
figs.push("iv32 9.2.5.6(12)");
figs.push("iv42 9.2.5.8(15)");
...
figs.push("v34 9.4.1.3(12)");
figs.push("v44 9.4.1.4(15)");
figs.push("v54 9.4.1.5(18)");
figs.push("v64 9.4.1.6(20)");
figs.push("v74 9.4.1.7(23)");
figs.push("v84 9.4.1.8(25)");
figs.push("d24 9.4.2.2(7:11)");
figs.push("d34 9.4.2.3(10)");
figs.push("d44 9.4.2.4(13)");
figs.push("d54 9.4.2.5(15)");
figs.push("d64 9.4.2.6(17)");
figs.push("d74 9.4.2.7(20)");
figs.push("d84 9.4.2.8(22)");
...
figs.push("id54 9.4.4.5(13)");
figs.push("id64 9.4.4.6(15)");
figs.push("id74 9.4.4.7(17)");
figs.push("id84 9.4.4.8(19)");
figs.push("iv24 9.4.5.2(5:8)");
figs.push("iv34 9.4.5.3(8:12)");
figs.push("iv44 9.4.5.4(11)");
figs.push("iv54 9.4.5.5(13)");
figs.push("iv64 9.4.5.6(15)");
figs.push("iv74 9.4.5.7(17)");
figs.push("iv84 9.4.5.8(19)");

// 8      84 86 88 810 812 814 816
figs.push("v8 9.8.1.1(7:11)");
figs.push("v28 9.8.1.1(7:11)");
figs.push("v48 9.8.1.2(11)");
figs.push("v68 9.8.1.3(15)");
figs.push("v88 9.8.1.4(19)");
figs.push("v108 9.8.1.5(23)");
figs.push("v128 9.8.1.6(26)");
figs.push("v148 9.8.1.7(30)");
figs.push("v168 9.8.1.8(33)");
figs.push("d8 9.8.2.1(5:8)");
figs.push("d28 9.8.2.1(5:8)");
figs.push("d48 9.8.2.2(9:14)");
figs.push("d68 9.8.2.3(13)");
figs.push("d88 9.8.2.4(17)");
figs.push("d108 9.8.2.5(20)");
figs.push("d128 9.8.2.6(23)");
figs.push("d148 9.8.2.7(27)");
figs.push("d168 9.8.2.8(30)");
...
figs.push("id68 9.8.4.3(11)");
figs.push("id88 9.8.4.4(15)");
figs.push("id108 9.8.4.5(18)");
figs.push("id128 9.8.4.6(21)");
figs.push("id148 9.8.4.7(24)");
figs.push("id168 9.8.4.8(27)");
figs.push("iv8 9.8.5.1(3:5)");
figs.push("iv28 9.8.5.1(3:5)");
figs.push("iv48 9.8.5.2(7:11)");
figs.push("iv68 9.8.5.3(11)");
figs.push("iv88 9.8.5.4(15)");
figs.push("iv108 9.8.5.5(18)");
figs.push("iv128 9.8.5.6(21)");
figs.push("iv148 9.8.5.7(24)");
figs.push("iv168 9.8.5.8(27)");

// 2    3    1  5   6  7  9 
figs.push("+v2f 9.9.1.2(15:18)");
figs.push("+v3f 9.9.1.3(15:20)");
figs.push("+v1f 9.9.1.4(15:22)");
figs.push("+v5f 9.9.1.5(17)");
figs.push("+v6f 9.9.1.6(19)");
figs.push("+v7f 9.9.1.7(21)");
figs.push("+v9f 9.9.1.8(23)");
figs.push("+d2f 9.9.2.2(13:15)");
figs.push("+d3f 9.9.2.3(13:17)");
figs.push("+d1f 9.9.2.4(13:19)");
figs.push("+d5f 9.9.2.5(15)");
figs.push("+d6f 9.9.2.6(16)");
figs.push("+d7f 9.9.2.7(18)");
figs.push("+d9f 9.9.2.8(20)");
...
figs.push("-v3f 9.9.6.3(17:20)");
figs.push("-v1f 9.9.6.4(17:22)");
figs.push("-v5f 9.9.6.5(20)");
figs.push("-v6f 9.9.6.6(22)");
figs.push("-v7f 9.9.6.7(24)");
figs.push("-v9f 9.9.6.8(26)");
figs.push("-d2f 9.9.7.2(15:18)");
figs.push("-d3f 9.9.7.3(15:20)");
figs.push("-d1f 9.9.7.4(15:22)");
figs.push("-d5f 9.9.7.5(17)");
figs.push("-d6f 9.9.7.6(19)");
figs.push("-d7f 9.9.7.7(21)");
figs.push("-d9f 9.9.7.8(23)");
...
figs.push("-v3if 9.10.1.3(17:23)");
figs.push("-v1if 9.10.1.4(17:25)");
figs.push("-v5if 9.10.1.5(20)");
figs.push("-v6if 9.10.1.6(22)");
figs.push("-v7if 9.10.1.7(24)");
figs.push("-v9if 9.10.1.8(26)");
figs.push("-d2if 9.10.2.2(15:18)");
figs.push("-d3if 9.10.2.3(15:20)");
figs.push("-d1if 9.10.2.4(15:22)");
figs.push("-d5if 9.10.2.5(17)");
figs.push("-d6if 9.10.2.6(19)");
figs.push("-d7if 9.10.2.7(21)");
figs.push("-d9if 9.10.2.8(23)");
...
figs.push("+v3if 9.10.6.3(19:23)");
figs.push("+v1if 9.10.6.4(19:25)");
figs.push("+v5if 9.10.6.5(22)");
figs.push("+v6if 9.10.6.6(24)");
figs.push("+v7if 9.10.6.7(27)");
figs.push("+v9if 9.10.6.8(29)");
figs.push("+d2if 9.10.7.2(17:21)");
figs.push("+d3if 9.10.7.3(17:23)");
figs.push("+d1if 9.10.7.4(17:25)");
figs.push("+d5if 9.10.7.5(19)");
figs.push("+d6if 9.10.7.6(21)");
figs.push("+d7if 9.10.7.7(24)");
figs.push("+d9if 9.10.7.8(26)");
