...
// 8.6.18.1-4
figs.push("+&rp(^)^+ 8.6.18.1(13) ~v_''''~p!__''~");
figs.push("-&rp(^)^- 8.6.18.2(14) ~V_''''~P!__''~");
figs.push("+&irp(^)^+ 8.6.18.3(14) ~V_''''~P!__''~");
figs.push("-&irp(^)^- 8.6.18.4(14) ~v_''''~p!__''~");
...
// 8.6.21.1-4
figs.push("+_p(^)&- 8.6.21.1(14) ~~_p!_~~''_V~");
figs.push("-_p(^)&+ 8.6.21.2(14) ~~_P!_~~''_v~");
figs.push("+_ip(^)&- 8.6.21.3(14) ~~_P!_~~_''v~");
figs.push("-_ip(^)&+ 8.6.21.4(14) ~~_p!_~~_''V~");

// 8.6.22.1-4
figs.push("+_p(^)&+ 8.6.22.1(13) ~~_p!_~~''_v~");
figs.push("-_p(^)&- 8.6.22.2(15) ~~_P!_~~''_V~");
figs.push("+_ip(^)&+ 8.6.22.3(14) ~~_P!_~~''_V~");
figs.push("-_ip(^)&- 8.6.22.4(13) ~~_p!_~~''_v~");
