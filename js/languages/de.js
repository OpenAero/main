...
'aboutNewer' : 'Sie benutzen eine neuere Version als die stabile und haben ' +
  'die aller neuesten Features, welcher aber noch fehlerhaft sein können. ' +
...
'aboutText' : '<div class="divider">' +
  ...
  '<a id="viewChangelog">Siehe changelog.txt</a></div>' +
  '<div class="divider">' +
  ...
  'OLAN sequence coding.<br> Viele haben dazu beigetragen, inklusive:' +
  '<table>' +
...
'checkAlert' : {
	'exactlyperfig' : 'Genau %s von %s je Figur',
  'maxperfig' : 'Nicht mehr als %s von %s je Figur',
  'minperfig' : 'Mindestens %s von %s je Figur',
  'exactly'   : 'Genau %s von %s erforderlich',
  ...
  'totrepeat' : 'Nicht mehr als %s Instanzen exakter Wiederholung von ' +
    '%s erlaubt',
  'figexactly': 'Genau %s von %s erforderlich',
...
'checkMultiUseReference' : 'Use <a href="#">Referenzsequenz</a> ' +
...
'downwind' : 'Rückenwind',
'downwindEntry' : 'Gegenwind Eingang',
...
'editingFigure' : 'Figur bearbeiten %s',
...
'figureEditor' : 'Figuren-Gestalter',
'figureK' : 'Figuren-K',
...
'flightNr' : 'Flug #',
    'flipYAxis': 'Y-axis umdrehen',
    'flyingMode': 'Flugmodus',
'flyingModeWind': 'Wind',
'forElement' : ' für Element ',
'formA' : 'Form A',
'formB' : 'Form B / Wind Rechts',
'formC' : 'Form C / Wind Links',
'formGridSequenceInfo' : 'mit Sequenz-Info',
'formL' : 'Form L',
'formR' : 'Form R',
'free' : 'Frei',
...
'FUconfirmExit' : 'Der Sequenz-Designer mag in dieser Situation nicht erneut ' +
  ...
  'Bestätigen Sie das Verlassen des Sequenz-Designers!',
...
'FUerrorsDetected' : 'Sequenz fehlerhaft, siehe unten:',
...
'gridAdditionals' : 'Zusatzfiguren benötigt.',
'gridInfo' : 'Gitterinformation',
'gridNegEntry' : 'Negativer Eingang',
'gridNegExit' : 'Negative Ausgang',
'gridOrderBy' : 'Sortieren nach',
'gridPosEntry' : 'Positiver Eingang',
'gridPosExit' : 'Positiver Ausgang',
'gridSpeed' : 'Geschwindigkeit',
'gridView' : 'Die Gitterspaltenansicht ist in der Gitteransicht zu finden. ',
'harmony' : 'Harmonie',
'help' : 'Hilfe',
'hideIllegalFigures' : 'Illegale Figuren ausblenden.(Sequenz-Regeln)',
    'iacForms': 'Formulare im IAC-Stil',
...
'nonArestiRolls' : 'Erlaube Nicht-Aresti-Figuren und nicht regulierte Rollen und Kombinationen ' +
  'Probieren Sie den Sequenz-String <i>41h4,f,4 66</i>)',
'none' : 'Keine',
...
'png' : 'PNG',
'positionClearAuto' : 'Positioniere automatische neue/geänderte Figuren ' +
  'frei von anderen',
...
// new 2020.1.5
    'printPageSet': 'Seitensatz',
    'printPageSetHidesFormSelectors': 'Wenn "Seitensatz" aktiv ist ' +
...
'referenceFigureDifferent' : 'Figur %s uunterscheidet sich von der Referenzsequenz.',
...
'separateFiguresConfirm' : 'Dies wird die Figuren voneinander trennen ' +
	'und alle vroherigen Sequenzpositionierungen entfernen ' +
  'Sind Sie sicher fortzufahren?',
'sequence' : 'Sequenz',
...
'totalK' : 'Gesamt K',
'trgViolation' : 'Verletzung auslösen',
...
'zipImageFilenamePattern' : 'Figureneizelbilder-Dateinamenmuster',
'zoom' : 'Zoom'
