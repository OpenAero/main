...
'addingFigure' : 'Ajouter une nouvelle figure',
    ...
    'additionalFigureRequired': 'Au moins 1 figure liaison requis',
'addSequenceLink' : 'Ajouter un lien de programme',
    'addToQueue': 'Ajouter à la file',
    'addWindAfterPilotCardCharacter': 'Ajoutez l\'un des <strong>><=</strong> après le ' +
        'caractère de la carte pilote pour choisir la direction du vent.',
'acreg': 'Immat d\'Avion',
'actype': 'Avion',
...
'optimalSequenceAreaExceeded' : 'Le programme dépasse la zone optimale',
'orderCountry' : 'Pays',
...
'tooltip' : {
  ...
  'rotate90': 'Faire pivoter dans la vue en tableau',
