 ...
 *        of figures (lines without "=" eg 7.2.1-2) an alerts occurs
 ...
 *        NOU rule for the figure 1.2.1 line
 ...
 * rule-A=x:regex when A is attacehd to allow figure: apply conv-x to
