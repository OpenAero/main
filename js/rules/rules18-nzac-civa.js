// OpenAero rules18-nzac-civa.js file
...
// This file defines rules for the NZAC 2017/2018 season
...
rules.push("reference=\"@A\" mf,1- \"@B\" -1j1- \"@C\" dh8 \"@D\" 2g24- \"@E\" -iv``5is''");

// what info should be filled out
rules.push("infocheck=pilot;actype;acreg;positioning");

/**********************************************************************
 *           Advanced, Intermediate Super Families                           *
 **********************************************************************/
...
rules.push("more=NZAC Intermediate Free Unknown");
...
rules.push("more=NZAC Intermediate Unknownall");
...
//#######################################################################################
rules.push("(NZAC Intermediate Unknownall)");
//#######################################################################################
...
rules.push("more=NZAC Intermediate Unknownbase");
rules.push("(NZAC Intermediate Unknownbase)");
...
rules.push("reference=\"@A\" -isirp24,f \"@B\" 3joi3 \"@C\" 2fg44 \"@D\" 4h2 \"@E\" -3,34m,22");
...
rules.push("poslj=20");
rules.push("reference=\"@A\" 5s,\"|\"3ib`3,2 \"@B\" 2jio15- 2% \"@C\" ```-9iac(`6f`)3,5-```` \"@D\" 4,2fh5 \"@E\" 22m,3if,7-");
...
// ~%~  ~i?d%~ ~i?v%~
//1.1.1-4  009 only as linking figures
rules.push("1.1.2.1");
